<%@ Page Title="CosaNostra Pizza - Management - Insert & Update Reviews" Language="C#" MasterPageFile="~/MasterPages/Management.master" AutoEventWireup="true" CodeFile="AddEditReview.aspx.cs" Inherits="Management_AddEditReview" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMainContent" Runat="Server">
        ...
        <Fields>
            ...
            <asp:TemplateField HeaderText="Title" SortExpression="Title">
                <EditItemTemplate>
                    ...
                    <asp:RequiredFieldValidator ControlToValidate="TextBox1" runat="server" ErrorMessage="A Title is required."></asp:RequiredFieldValidator>
                </EditItemTemplate>
                <InsertItemTemplate>
                    <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("Title") %>'></asp:TextBox>
                    <asp:RequiredFieldValidator ControlToValidate="TextBox1" runat="server" ErrorMessage="A Title is required."></asp:RequiredFieldValidator>
            ...
            <asp:TemplateField HeaderText="Summary" SortExpression="Summary">
                <EditItemTemplate>
                    ...
                    <asp:RequiredFieldValidator ErrorMessage="A Summary is required." ControlToValidate="TextBox2" runat="server" />
                </EditItemTemplate>
                <InsertItemTemplate>
                    <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("Summary") %>' TextMode="MultiLine" Width="500" Height="100"></asp:TextBox>
                    <asp:RequiredFieldValidator ErrorMessage="A Summary is required." ControlToValidate="TextBox2" runat="server" />
    ...
    <asp:SqlDataSource ID="GenresDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:CosaNostraPRODConnectionString1 %>" SelectCommand="SELECT [Id], [Name] FROM [Genre] ORDER BY [SortOrder]"></asp:SqlDataSource>
</asp:Content>
