<%@ Page Title="CosaNostra Pizza - Management - Genres" Language="C#" MasterPageFile="~/MasterPages/Management.master" AutoEventWireup="true" CodeFile="Genres.aspx.cs" Inherits="Management_Genres" %>
...
<ItemStyle Width="200px"></ItemStyle>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CosaNostraPRODConnectionString1 %>" ProviderName="<%$ ConnectionStrings:CosaNostraPRODConnectionString1.ProviderName %>" 
