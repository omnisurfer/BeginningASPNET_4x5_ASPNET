...
<script type="text/javascript">
    function validatePhoneNumbers(source, args) {
        ...
        var phoneBusiness = document.getElementById('<%= BusinessPhone.ClientID %>');
    ...
    <ContentTemplate>
        <div id="TableWrapper">
            <table class="auto-style1" runat="server" id="FormTable">
                <tr>
                    <td colspan="3">
                        <h1>Contact CosaNostra Pizza</h1>                                                                                    
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="auto-style2">
                        <asp:TextBox ID="HomePhone" runat="server" TextMode="Phone" ClientIDMode="Static"></asp:TextBox>
                        <asp:CustomValidator ID="CustomValidator1" runat="server" CssClass="ErrorMessage" ErrorMessage="Enter your home of business phone number." OnServerValidate="CustomValidator1_ServerValidate" ClientValidationFunction="validatePhoneNumbers" Display="Dynamic">*</asp:CustomValidator>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td class="auto-style3">Business Phone</td>
                    <td class="auto-style2">
                        <asp:TextBox ID="BusinessPhone" runat="server" TextMode="Phone" ClientIDMode="Static"></asp:TextBox>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
