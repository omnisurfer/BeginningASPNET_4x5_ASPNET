...
[assembly: EdmRelationshipAttribute("CosaNostraPRODModel", "FK_Review_Genre", "Genre", System.Data.Metadata.Edm.RelationshipMultiplicity.One, typeof(CosaNostraPRODModel.Genre), "Review", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, typeof(CosaNostraPRODModel.Review), true)]
[assembly: EdmRelationshipAttribute("CosaNostraPRODModel", "FK_Picture_PhotoAlbum", "PhotoAlbum", System.Data.Metadata.Edm.RelationshipMultiplicity.One, typeof(CosaNostraPRODModel.PhotoAlbum), "Picture", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, typeof(CosaNostraPRODModel.Picture), true)]

#endregion

namespace CosaNostraPRODModel
{
    #region Contexts
    ...
    /// </summary>
    public partial class CosaNostraPRODEntities : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new CosaNostraPRODEntities object using the connection string found in the 'CosaNostraPRODEntities' section of the application configuration file.
        /// </summary>
        public CosaNostraPRODEntities() : base("name=CosaNostraPRODEntities", "CosaNostraPRODEntities")
        {
        ...
        /// <summary>
        /// Initialize a new CosaNostraPRODEntities object.
        /// </summary>
        public CosaNostraPRODEntities(string connectionString) : base(connectionString, "CosaNostraPRODEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new CosaNostraPRODEntities object.
        /// </summary>
        public CosaNostraPRODEntities(EntityConnection connection) : base(connection, "CosaNostraPRODEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="CosaNostraPRODModel", Name="Genre")]
    [Serializable()]
    ...
    public partial class Genre : EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("CosaNostraPRODModel", "FK_Review_Genre", "Review")]
        public EntityCollection<Review> Reviews
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<Review>("CosaNostraPRODModel.FK_Review_Genre", "Review");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<Review>("CosaNostraPRODModel.FK_Review_Genre", "Review", value);
                }
            }
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="CosaNostraPRODModel", Name="PhotoAlbum")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class PhotoAlbum : EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("CosaNostraPRODModel", "FK_Picture_PhotoAlbum", "Picture")]
        public EntityCollection<Picture> Pictures
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<Picture>("CosaNostraPRODModel.FK_Picture_PhotoAlbum", "Picture");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<Picture>("CosaNostraPRODModel.FK_Picture_PhotoAlbum", "Picture", value);
                }
            }
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="CosaNostraPRODModel", Name="Picture")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class Picture : EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("CosaNostraPRODModel", "FK_Picture_PhotoAlbum", "PhotoAlbum")]
        public PhotoAlbum PhotoAlbum
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<PhotoAlbum>("CosaNostraPRODModel.FK_Picture_PhotoAlbum", "PhotoAlbum").Value;
            }
            set
            {
                ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<PhotoAlbum>("CosaNostraPRODModel.FK_Picture_PhotoAlbum", "PhotoAlbum").Value = value;
            }
        }
        /// <summary>
        /// No Metadata Documentation available.
        ...
        public EntityReference<PhotoAlbum> PhotoAlbumReference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<PhotoAlbum>("CosaNostraPRODModel.FK_Picture_PhotoAlbum", "PhotoAlbum");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<PhotoAlbum>("CosaNostraPRODModel.FK_Picture_PhotoAlbum", "PhotoAlbum", value);
                }
            }
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="CosaNostraPRODModel", Name="Review")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class Review : EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("CosaNostraPRODModel", "FK_Review_Genre", "Genre")]
        public Genre Genre
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<Genre>("CosaNostraPRODModel.FK_Review_Genre", "Genre").Value;
            }
            set
            {
                ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<Genre>("CosaNostraPRODModel.FK_Review_Genre", "Genre").Value = value;
            }
        }
        /// <summary>
        /// No Metadata Documentation available.
        ...
        public EntityReference<Genre> GenreReference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<Genre>("CosaNostraPRODModel.FK_Review_Genre", "Genre");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<Genre>("CosaNostraPRODModel.FK_Review_Genre", "Genre", value);
                }
            }
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="CosaNostraPRODModel", Name="sysdiagram")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
